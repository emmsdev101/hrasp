...
export default function ChangePassword({ show, handleClose, panel,committee, admin }) {
  ...
  const submit = async() => {
    ...
    const request = await axios.post(url,{currentPassword:currPassword,newPassword},{withCredentials:true})
