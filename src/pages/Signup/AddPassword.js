...
export default function AddPassword({ next }) {
  const { password, handlePassword, retype, handleRetype, submit } =
    useAddPassword(next);
  return (
    <Row className="d-flex flex-column align-items-center">
      <Col md={8}>
        <Container fluid className="signup-box pt-5">
          ...
          <Row className="formRow">
            <Col sm={12} md={12} lg={8}>
              <p className="alert alert-warning">
                Create a strong password with at least 8 characters, 1 special
                character, 1 number and 1 upper case and lower cause character.
              </p>
            </Col>
          </Row>
          <Form>
